variable "aws_private_agent_group-1_zone" {
   default = "a"
}

variable "var.num_of_private_agents_group_1" {
   default = "1"
}

# Create a subnet to launch slave private node into
resource "aws_subnet" "private_group-1" {
...
resource "aws_instance" "agent_group_1" {
  ...
  count = "${var.num_of_private_agents_group_1}"
